...
public class CustomizeManager : MonoBehaviour
{
   ...
   [Header("---------------Ninja Material Operation")]
    ...
    public void Buyitem()
    {
        ...
        _ItemInfo[Currentindex + Added›ndex].Bought = true;
    ...
    private void BuyAndSaveButManager()
    {
        if (Currentindex != -1)
        {
            BuyAndSaveButtom[0].GetComponentInChildren<TextMeshProUGUI>().text = _ItemInfo[Currentindex + Added›ndex].Point.ToString() + "-"+ Buy;
            if (_ItemInfo[Currentindex + Added›ndex].Bought)
            {
                BuyAndSaveButtom[0].GetComponentInChildren<TextMeshProUGUI>().text = Purchased;
                SaveSitatu();
            }
            ...
            {
                BuyAndSaveButtom[1].interactable = false;
                if (_ItemInfo[Currentindex + Added›ndex].Point <= Point)
                {
